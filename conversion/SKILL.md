...
> **This repo (cybergym_tasks20260923B).** The prime bundles live under
> `cybergym_tasks20260923B/`, and the conversion toolkit is a self-contained copy under
...
From the `cybergym_tasks20260923B/` directory (where the bundles are):

```bash
cd cybergym_tasks20260923B
# one bundle
